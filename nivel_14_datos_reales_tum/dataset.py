...
class SecuenciaTUM:
    ...
    da el ORDEN y el INSTANTE real de captura de cada frame. (La variante con
    profundidad — depth.txt, PNG de 16 bits — llega en el nivel 15.)
    """
